package org.gojo.learn.controller.logging;
 ...
 * configuration assumptions, etc). Info I want to always have available but usually don't care
 * about under normal circumstances. This is my out-of-the-box config level.
 * @Warn - Anything that
 * can potentially cause application oddities, but for which I am automatically recovering. (Such as
 ...
 * a required file, missing data, etc.). These errors will force user (administrator, or direct
 ...
 * to prevent data loss (or further data loss). I reserve these only for the most heinous errors and
